sap.ui.define([
	...
	return Opa5.extend("opensap.webapp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["opensap/webapp/localService/mockserver"], function (mockserver) {
