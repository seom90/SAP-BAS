sap.ui.define([
	...
	return Opa5.extend("opensap.HTML5Module.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["opensap/HTML5Module/localService/mockserver"], function (mockserver) {
