		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Tests",
									"targetURL": "#studentseomcomsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentseomcomsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "studentseomcomsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentseom.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("studentseom/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
