		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#studentseomcomsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentseomcomsaptrainingux402opaux402opa-display": {
								"semanticObject": "studentseomcomsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentseom.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("studentseom/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
